<?php include "header.php" ?>
    <div class="row mt-lg-4 ">
		...
		<div class="col-lg-10 control-div">
            ...
            <h5 class="pb-2 text-spruce font-weight-bold"><span class="fa fa-users"></span> Students</h5>
                <hr class="mt-1 mb-3"/>
                ...
                <?php foreach($subjects as $subject): ?>
                    <div class="col-lg-4">
                        <div class="w3-card w3-round-large spruce w3-btn m-2 w-100">
                            ...
                            <a class="btn w3-btn w3-round-large w3-teal" href="<?= base_url("control_panel/show_users/$subject->id"); ?>" ><span class="fa fa-users"></span> Show Students</a>
                        </div>
                    </div>
                <?php endforeach; ?>
            </div>
